...
**Current task:** T2.5
**Blockers:** Ninguno para T2.5. Antes de las tareas afectadas falta cerrar el criterio de mejores resultados y el comportamiento de «repetir fallos». El cronómetro queda fuera del alcance confirmado salvo nueva decisión.

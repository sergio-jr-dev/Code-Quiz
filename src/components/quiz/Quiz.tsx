...
export const Quiz = () => {
  const { currentQuestion, shuffleQuestions, question, selectedOption } =
    useQuiz();
  ...
  return (
    <article className="quiz">
      <span className="badge" aria-live="polite" aria-atomic="true" aria-label={`Pregunta ${currentQuestion + 1} de ${shuffleQuestions.length}`}>
